            ...
            <div class="main-panel">
                ...
                <footer class="footer">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © VictorW-dev 2021</span>
                        <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> Acess <a href="https://github.com/VictorW-dev" target="_blank">Github</a> from VictorW-dev</span>
                    </div>
                </footer>
                <!-- partial -->
            </div>
